...
var DismissableLayerBranch = React4.forwardRef(__name2(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React4.useContext(DismissableLayerContext);
...
__name4(useStateMachine, "useStateMachine");
var Presence = __name4((props) => {
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name4((event) => {
      ...
      const handleAnimationStart = __name4((event) => {
...
__name4(usePresence, "usePresence");
...
__name4(useStableComposedRefs, "useStableComposedRefs");
function getAnimationName(styles) {
  return styles?.animationName || "none";
}
__name4(getAnimationName, "getAnimationName");
...
var VisuallyHidden = React10.forwardRef(
  __name6(function VisuallyHidden2(props, forwardedRef) {
...
//# sourceMappingURL=chunk-4EDARGOJ.js.map
