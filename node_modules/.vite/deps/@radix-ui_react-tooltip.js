...
import {
  createSlottable,
  useComposedRefs
} from "./chunk-JCX6HDRL.js";
import {
  require_jsx_runtime
} from "./chunk-3CUH6HET.js";
import {
  require_react
...
var TooltipProvider = __name3((props) => {
  const {
    __scopeTooltip,
...
var TooltipTrigger = React6.forwardRef(
  __name3(function TooltipTrigger2(props, forwardedRef) {
...
var TooltipPortal = __name3((props) => {
...
var TooltipContent = React6.forwardRef(
  __name3(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React6.forwardRef(__name3(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  ...
  React6.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name3((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name3((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React6.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name3((event) => {
...
var TooltipContentImpl = React6.forwardRef(
  ...
  __name3(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
    ...
    React6.useEffect(() => {
      if (context.trigger) {
        const handleScroll = __name3((event) => {
...
var TooltipArrow = React6.forwardRef(
  __name3(function TooltipArrow2(props, forwardedRef) {
...
__name3(getExitSideFromRect, "getExitSideFromRect");
...
__name3(getPaddedExitPoints, "getPaddedExitPoints");
...
__name3(getPointsFromRect, "getPointsFromRect");
...
__name3(isPointInPolygon, "isPointInPolygon");
...
__name3(getHullPresorted, "getHullPresorted");
