            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className={`w-10 h-10 rounded-xl bg-background/60 border ${cert.border} flex items-center justify-center font-bold text-sm ${cert.initialsColor}`}>
                    {cert.initial}
                  </div>
                  <div>
                    <p className={`text-sm font-bold ${cert.initialsColor}`}>{cert.issuer}</p>
                    <p className="text-xs text-muted-foreground flex items-center gap-1">
                      <Calendar className="w-3 h-3" /> {cert.date}
                    </p>
                  </div>
                  <div className="ml-auto">
                    <BadgeCheck className={`w-5 h-5 ${cert.initialsColor}`} />
                  </div>
                </div>
          ...
          >
            ...
            >
              ...
              <div className="bg-background/95 px-5 py-3 flex items-center justify-between">
                <div>
                  <p className="text-sm font-bold">{activeCert.title}</p>
                  <p className="text-xs text-muted-foreground">{activeCert.issuer} · {activeCert.date}</p>
                </div>
